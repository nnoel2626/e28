    ...
    <div class="container product">
      <div class="card text-left">
        <div class="card-header">
          <h5 data-test="product-model" class="card-header-title product-model">
            Model: {{ product.model }}
          </h5>
        </div>
        <div class="card-content">
          ...
          <p class="product-subtitle mb-2">
            Frequency: {{ product.Assigned_freq }}
          </p>
          <p class="product-subtitle mb-2">
            Group: {{ product.group }} and{{ product.channel }}
          </p>
        </div>
        <div class="card-footer bg-transparent">
          ...
          >
            <button
              data-test="product-details-button"
